...
abstract class AppLocalizations {
  ...
  /// No description provided for @addWidget_manuallyAddANewAliment.
  ///
  /// In en, this message translates to:
  /// **'Manually add a new aliment'**
  String get addWidget_manuallyAddANewAliment;

  /// No description provided for @addWidget_scanAnAlimentBarcode.
  ///
  /// In en, this message translates to:
